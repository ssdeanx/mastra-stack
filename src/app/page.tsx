...
function SunIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-14 h-14 text-yellow-200" role="img" aria-labelledby="sunIconTitle">
      <title id="sunIconTitle">Sun icon</title>
...
function RainIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-14 h-14 text-blue-200" role="img" aria-labelledby="rainIconTitle">
      <title id="rainIconTitle">Rain icon</title>
      {/* Cloud */}
...
function CloudIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-14 h-14 text-gray-200" role="img" aria-labelledby="cloudIconTitle">
      <title id="cloudIconTitle">Cloud icon</title>
